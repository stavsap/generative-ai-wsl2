...
curl https://raw.githubusercontent.com/stavsap/generative-ai-wsl2/main/DragGen/run.sh > run.sh
chmod +x run.sh

curl https://raw.githubusercontent.com/stavsap/generative-ai-wsl2/main/DragGen/update.sh > update.sh
chmod +x update.sh
